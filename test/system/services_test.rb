...
class ServicesTest < ApplicationSystemTestCase
  ...
  test "should create service" do
    ...
    fill_in "Devconsole url", with: @service.devconsole_url
    fill_in "Expected status", with: @service.expected_status
    fill_in "Gcp tag", with: @service.gcp_tag
    fill_in "Internal notes", with: @service.internal_notes
    fill_in "Inventory item", with: @service.inventory_item_id
    fill_in "Name", with: @service.name
    fill_in "Priority", with: @service.priority
