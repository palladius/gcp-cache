...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference("Folder.count") do
      post folders_url, params: { folder: { folder_id: @folder.folder_id, is_org: @folder.is_org, name: @folder.name, parent_id: @folder.parent_id } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { folder_id: @folder.folder_id, is_org: @folder.is_org, name: @folder.name, parent_id: @folder.parent_id } }
