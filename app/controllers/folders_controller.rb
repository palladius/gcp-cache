class FoldersController < ApplicationController
  ...
  private
    ...
    def folder_params
      params.require(:folder).permit(:name, :folder_id, :is_org, :parent_id, :description, :domain, :directory_customer_id, :lifecycle_state, :gcp_creation_time, :frog_type, :active)
    end
end
